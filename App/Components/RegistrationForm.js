...
class RegistrationForm extends React.Component {
  ...
  setAgreementAccepted(accepted) {
    this.setState({agreementAccepted: accepted});
  }

  render () {
    const { handleSubmit } = this.props
    const agreementAccepted = this.state.agreementAccepted
    registrationOnPress = function() {
      agreementAccepted ? handleSubmit() : Toast.show('You must accept our EULA')
    }
          ...
          <ScrollView>
            <View style={{alignItems: 'center', justifyContent: 'center'}}>
              <Text style={{marginVertical: 20, fontSize: 30}}>
                Buymeby EULA (End User License Agreement)
              </Text>
...
<Text style={{marginBottom: 20}}>
i. Content or User which is objectionable will be blocked from the Buymeby and Sellmeby app ecosystem by moderators. Objectionable content includes, but is not limited to (a) sexually explicit materials; (b) obscene, defamatory, libelous, slanderous, violent and/or unlawful content or profanity; (c) content that infringes upon the rights of any third party, including copyright, trademark, privacy, publicity, or other personal or proprietary right, or that is deceptive or fraudulent; (d) content that promotes the use or sale of illegal or regulated substances, tobacco products, ammunition and/or firearms; and (e) gambling, including without limitation, any online casino, sports books, bingo, or poker. There is no tolerance for objectionable content or abusive users.
</Text>
<Text style={{marginBottom: 20}}>
...
Specifically excluded from application to this Agreement is that law known as the United Nations Convention on the International Sale of Goods.
              ...
              <TouchableOpacity style={styles.button} onPress={() => { this.setAgreementAccepted(true); this.setModalVisible(false); }}>
                <Text style={styles.buttonText}>ACCEPT</Text>
              </TouchableOpacity>
              <TouchableOpacity style={{marginBottom: 20}} onPress={() => { this.setAgreementAccepted(false); this.setModalVisible(false) }}>
                <Text>Cancel</Text>
              </TouchableOpacity>
            </View>
          </ScrollView>
        ...
        <View style={styles.centered}>
          <TouchableOpacity onPress={() => this.setModalVisible(true)}>
            <Text style={{textAlign: 'center', paddingTop: 10}}>{`By registering, I accept Buymeby's End User License Agreement`} </Text>
          </TouchableOpacity>
          <TouchableOpacity style={styles.button} onPress={registrationOnPress}>
